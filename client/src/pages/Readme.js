        ...
        <>
            ...
            <Container className="p-5">
                <article className="markdown-body entry-content" itemProp="text">
                    <div>
                        <h1>My Restaurant - React ecommerce website</h1>
                        <hr/>
                        <p>My Restaurant is an ecommerce website built using React, Redux integrated with Node.js and Express backend.</p>
